    ...
    <section className="max-w-7xl mx-auto px-4 py-16 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
        {features.map((feature, index) => (
          ...
          >
            <div
              className="w-24 h-24 rounded-full mb-6 flex flex-center justify-center items-center"
              style={{
                backgroundColor:
      ...
      <div className="text-center mt-12">
        <button className="bg-blue-600 text-white cursor-pointer px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition-colors relative shadow-2xl backdrop-blur-2xl   ">
                  Become a Partner
                  <div className="absolute -z-10 w-full h-full rounded-full bg-blue-600/50 top-0 left-0 blur-xl"></div>
        </button>
      </div>
    </section>
  );
